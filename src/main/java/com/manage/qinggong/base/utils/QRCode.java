...
public class QRCode {
     ...
     * @throws WriterException
     */
    public static String encode(String content, String logoImagePath, String destPath, boolean needCompressed) throws IOException, WriterException {
    ...
    public static String encode(String content, String destPath) throws Exception {
        return QRCode.encode(content, null, destPath, false);
    }
